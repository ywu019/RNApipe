...
if config["TRIM"] == "fastp":
    ...
    os.system("nice -5 snakemake -j 10  -s rules/qc_fastp.py 2>&1 | tee logs/log_fastp.txt")
    end_time = time.time()
    ...
    print("Start Trimming!")
    start_time = time.time()
    os.system("nice -5 snakemake -j 10  -s rules/qc_cutadapt.py 2>&1 | tee logs/log_cutadapt.txt")
    end_time = time.time()
    file_log_time.write("Time of running trimming:" + spend_time(start_time, end_time) + "\n")
    print("Trimming is done!") 
...
if config["ALIGN"] == "hisat2":
    ...
    start_time = time.time()
    os.system("nice -5 snakemake -j 20 -s rules/align_hisat2.py 2>&1 | tee logs/log_hisat2.txt")
    end_time = time.time()
    ...
    print("Start Mapping to genome!")
    start_time = time.time()
    os.system("nice -5 snakemake -j 20  -s rules/align_star.py 2>&1 | tee logs/log_star.txt")
    end_time = time.time()
    file_log_time.write("Time of running mapping:" + spend_time(start_time, end_time) + "\n")
    print("Mapping is done!") 
...
if config["BIGWIG"] == "yes":
    ...
    start_time = time.time()
    os.system("nice -5 snakemake -j 20  -s rules/bamtobigwig.py 2>&1 | tee logs/log_deeptools.txt")
    end_time = time.time()
...
if config["QUANTIFY"] == "featureCounts":
    ...
    start_time = time.time()
    os.system("nice -5 snakemake -j 20 -s rules/featurecounts.py 2>&1 | tee logs/log_featurecounts.txt")
    end_time = time.time()
    ...
    print("Start Quantifying!")
    start_time = time.time()
    os.system("nice -5 snakemake -j 20 -s rules/htseq.py 2>&1 | tee logs/log_htseq.txt")
    end_time = time.time()
    file_log_time.write("Time of running quantifying:" + spend_time(start_time, end_time) + "\n")
    print("Quantifying is done!")
...
start_time = time.time()
os.system("nice -5 snakemake -j 10 -s rules/exp_visualize.py 2>&1 | tee logs/log_visualize.txt")
end_time = time.time()
...
print("Start Multiqc!")
start_time = time.time()
os.system("nice -5 snakemake -j 10 -s rules/qualimap.py 2>&1 | tee logs/log_qualimap.txt")
end_time = time.time()
...
if config["DEA"] == "DESeq2":
    ...
    start_time = time.time()
    os.system("nice -5 snakemake -j 10 -s rules/dge_DESeq2.py 2>&1 | tee logs/log_dea_DESeq2.txt")
    end_time = time.time()
    ...
    print("Start doing DEA!")
    start_time = time.time()
    os.system("nice -5 snakemake -j 10 -s rules/dge_edgeR.py 2>&1 | tee logs/log_dea_edgeR.txt")
    end_time = time.time()
    file_log_time.write("Time of running DEA genome based:" + spend_time(start_time, end_time) + "\n")
    print("DEA is done!") 
    ...
    print("Start doing DEA!")
    start_time = time.time()
    os.system("nice -5 snakemake -j 10 -s rules/dge_limma.py 2>&1 | tee logs/log_dea_limma.txt")
    end_time = time.time()
    file_log_time.write("Time of running DEA genome based:" + spend_time(start_time, end_time) + "\n")
    print("DEA is done!")
...
start_time = time.time()
os.system("nice -5 snakemake --use-conda -j 10 -s rules/go_kegg.py 2>&1 | tee logs/log_kobas.txt")
end_time = time.time()
...
start_time = time.time()
os.system("nice -5 snakemake --use-conda -j 10 -s rules/gsea.py 2>&1 | tee logs/log_GSEA.txt")
end_time = time.time()
