...
rule star_index:
    ...
    shell:
        """
        STAR --runThreadN {params.thread} --runMode genomeGenerate --genomeDir {params.index} \
...
if END=="pair":
    rule star:
        ...
        shell:
            """
            STAR --outFilterType BySJout --runThreadN {params.thread} --outFilterMismatchNmax 2 --genomeDir {input.star_index}\
